...
- 📱 **Progressive Web App (PWA)**: Full offline commuter mode with multi-strategy Service Worker caching (`v109`).
...
├── sw.js & manifest.json        # PWA Service Worker (v109) & Web Manifest
