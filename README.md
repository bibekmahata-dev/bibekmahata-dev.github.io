...
- 📱 **Progressive Web App (PWA)**: Full offline commuter mode with multi-strategy Service Worker caching (`v107`).
...
├── sw.js & manifest.json        # PWA Service Worker (v107) & Web Manifest
