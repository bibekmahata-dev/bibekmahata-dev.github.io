# 🚂 Bengal Explorers — West Bengal Portal & Travel Dashboard

[![Website](https://img.shields.io/badge/Live-Website-00df8f?style=for-the-badge&logo=googlechrome&logoColor=black)](https://bibekmahata-dev.github.io/)
[![PWA Ready](https://img.shields.io/badge/PWA-Enabled-38bdf8?style=for-the-badge&logo=pwa&logoColor=white)](https://bibekmahata-dev.github.io/)
[![Author](https://img.shields.io/badge/Author-Bibek_Mahata-f59e0b?style=for-the-badge&logo=github&logoColor=white)](https://github.com/bibekmahata-dev)
...
- 🚆 **Live Transit Radar & Departure Boards**: Real-time scheduled departure monitors for Howrah, Sealdah, Kharagpur, Garhbeta, and regional railway junctions.
- 🔊 **Procedural Web Audio Engine**: Dual-tone station bell synthesizer chimes (587.33 Hz / 783.99 Hz) and built-in interactive SpeechSynthesis tour narrator HUD.
...
- 📱 **Progressive Web App (PWA)**: Full offline commuter mode with multi-strategy Service Worker caching (`v118`).
- 🧭 **Intuitive 8-Stage Architecture**: Unified flow seamlessly balancing daily local commuter tools (trains, buses, meteorology, emergency SOS) with visual discovery (38 authentic photographs, interactive GIS radar, 27 GI-tagged cultural vault).
...
├── sw.js & manifest.json        # PWA Service Worker (v118) & Web Manifest
...
└── 12 Dedicated Travel Guides:
    ...
    ├── guide-digha.html         # Coastal Bay of Bengal
    ├── guide-jhargram.html      # Jangalmahal Eco-Trails
    ├── guide-bengal-sweets.html # Royal GI Sweets
    ├── guide-kolkata-heritage.html # Victoria Memorial & Maidan
...
- **Frontend**: Semantic HTML5, Modular CSS3 (Custom Glassmorphism Design System), Vanilla ES6+ JavaScript
- **Mapping & GIS**: Leaflet.js, OpenStreetMap Tiles
- **Audio Synthesis**: Web Audio API (AudioContext), Web Speech API (SpeechSynthesis)
- **APIs**: Open-Meteo (Live Weather), VisitorBadge (Analytics)
- **Monetization & SEO**: Google AdSense, Schema.org JSON-LD

---

## 👨‍💻 Author & Lead Architect

- **Bibek Mahata** ([@bibekmahata-dev](https://github.com/bibekmahata-dev))
- **Role**: Founder, Lead Software Developer & CS Engineer
- **Instagram**: [@bibek.cs](https://www.instagram.com/bibek.cs)
- **YouTube**: [@bibekgamer_444](https://youtube.com/@bibekgamer_444)
- **Email**: [mahatabibek49@gmail.com](mailto:mahatabibek49@gmail.com) / [bibek.workdev01@gmail.com](mailto:bibek.workdev01@gmail.com)
