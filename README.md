...
- 📱 **Progressive Web App (PWA)**: Full offline commuter mode with multi-strategy Service Worker caching (`v106`).
...
├── sw.js & manifest.json        # PWA Service Worker (v106) & Web Manifest
