...
- 📱 **Progressive Web App (PWA)**: Full offline commuter mode with multi-strategy Service Worker caching (`v110`).
...
├── sw.js & manifest.json        # PWA Service Worker (v110) & Web Manifest
