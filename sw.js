...
const CACHE_NAME = 'bengal-explorers-v101';
const DATA_CACHE_NAME = 'bengal-data-cache-v101';
...
const APP_SHELL = [
    ...
    '/guide-sundarbans.html',
    '/guide-purulia.html',
    '/guide-mukutmanipur.html',
    '/guide-coochbehar.html',
    '/guide-shantiniketan.html',
    '/manifest.json',
    '/favicon.ico',
    '/favicon.png',
